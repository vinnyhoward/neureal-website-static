      ...
      <a href='https://medium.com/@Francesco_AI/the-convergence-of-ai-and-blockchain-whats-the-deal-60c618e3accc'>
        <div className='news-detail-container'>
          <div className='news-container-padding'>
            ...
            <div className='news-caption'>Why a decentralized intelligence may affect our future</div>
            <div className='news-caption'>It is undeniable that AI and blockchain are two of the major technologies that are catalyzing the pace of innovation
              and introducing radical shifts in every industry. Each technology has its...</div>
      ...
      <a href='https://cointelegraph.com/news/neureal-bringing-artificial-intelligence-to-the-people?utm_content=bufferae0b9&utm_medium=social&utm_source=facebook.com&utm_campaign=buffer'>
        <div className='news-detail-container'>
          <div className='news-container-padding'>
            ...
            <div className='news-caption'></div>
            <div className='news-caption'>Иeureal is the first decentralized open-source protocol designed to produce a distributed artificial intelligence
              (AI) architecture that is incentivized, maintained and housed...</div>
            <div className='learn-more-container'>
              <div className='news-learn-more'>Learn More</div>
            </div>
          </div>
      ...
      <a href='https://www.newgenapps.com/blog/future-of-ico-impact-of-initial-coin-offering'>
        <div className='news-detail-container'>
          <div className='news-container-padding'>
            ...
            <div className='news-caption'></div>
            <div className='news-caption'>ICO i.e. Initial Coin Offering is the new wave of fundraising where ideators ditch the complete hassle of the
              lengthy funding process and raise capital via blockchain technology...</div>
            <div className='learn-more-container'>
              <div className='news-learn-more'>Learn More</div>
            </div>
          </div>
      ...
      <a href='https://medium.com/@chain_explainer/blockchain-insider-jen-greyson-2610af01c709'>
        <div className='news-detail-container'>
          <div className='news-container-padding'>
            ...
            <div className='news-caption'></div>
            <div className='news-caption'>Recently named one of the Top 8 Women in Crypto, Jen Greyson of the Neureal Network and CEO of Powered by Neureal
              brings decades of executive leadership to the blockchain/crypto...</div>
            <div className='learn-more-container'>
              <div className='news-learn-more'>Learn More</div>
            </div>
          </div>
      ...
      <a href='https://medium.com/@JenGreyson/blockchain-5-years-from-now-cda989c3048b'>
        <div className='news-detail-container'>
          <div className='news-container-padding'>
            ...
            <div className='news-caption'></div>
            <div className='news-caption'>I had an interviewer ask me where I thought Ethereum was going to be in 5 years. Five years. That’s a lifetime
              in blockchain. Look what we’ve seen in the last five MONTHS....</div>
            <div className='learn-more-container'>
              <div className='news-learn-more'>Learn More</div>
            </div>
          </div>
      ...
      <a href='hhttp://usaweekly.com/2018/01/interview-with-jen-greyson-ceo-at-neureal/'>
        <div className='news-detail-container'>
          <div className='news-container-padding'>
            ...
            <div className='news-caption'></div>
            <div className='news-caption'>Starting a business is a big achievement for many entrepreneurs, but maintaining one is the larger challenge.
              There are many standard challenges that face every business whether they...</div>
            <div className='learn-more-container'>
              <div className='news-learn-more'>Learn More</div>
            </div>
          </div>
    ...
    <a href='https://vimeo.com/227450398'>
      <div className='news-detail-container'>
        <div className='news-container-padding'>
          ...
          <div className='podcast-detail-flex'><a className='headphone ion-headphone' /><div className='podcast-title'>Hour 3</div></div>
          <div className='learn-more-container'>
          </div>
        </div>
      </div>
    ...
    <a href='https://l.facebook.com/l.php?u=https%3A%2F%2Fbuff.ly%2F2DtDQym&h=ATPm5b78akZ7GXRdgF_PLrTXA6lbbW1wWlye2KSmX4OMv46h2jlSD9AuMAsn-Fd4WQGijhFFKjvwR-rWzkIsDM-vBluNkK-UGNnRnHwwQjjByLf4hmSJMS5MMEpgCBopvmWcWFecoLyhPpZyKM-_HWcAsN6f5c_0WTi0k9fy0-uEiTf5cIoo4aGWwyKbQtqsPVpBwvUUVA11JnR9olQ7l8cQ2sagq8dAUkSYVSsOQCyZHm0VBembhAKzZAReuBlIqqtfKYItIJ5ivNWlpUoouucPHGfeOcNMHSeLsgE'>
      <div className='news-detail-container'>
        <div className='news-container-padding'>
          ...
          <div className='podcast-detail-flex'><a className='headphone ion-headphone' /><div className='podcast-title'>On The Bus Podcast</div></div>
          <div className='learn-more-container'>
          </div>
        </div>
      </div>
    ...
    <a href='http://alwaysthejourney.com/2017/12/08/always-the-journey-podcast-episode-no-2/'>
      <div className='news-detail-container'>
        <div className='news-container-padding'>
          ...
          <div className='podcast-detail-flex'><a className='headphone ion-headphone' /><div className='podcast-title'>Always the Journey Podcast Episode No. 2</div></div>
          <div className='learn-more-container'>
          </div>
        </div>
      </div>
    ...
    <a href='http://freecitiespodcast.libsyn.com/decentral-hub-and-d10e-recap'>
      <div className='news-detail-container'>
        <div className='news-container-padding'>
          ...
          <div className='podcast-detail-flex'><a className='headphone ion-headphone' /><div className='podcast-title'>DeCentral Hub and D10e ReCap</div></div>
          <div className='learn-more-container'>
          </div>
        </div>
      </div>
    ...
    <a href='https://www.youtube.com/watch?v=tZ2XKUoNtyc'>
      <div className='news-detail-container'>
        <div className='news-container-padding'>
          ...
          <div className='podcast-detail-flex'><a className='headphone ion-headphone' /><div className='podcast-title'>Neureal Open-Source, Peer-to-Peer Pr</div></div>
          <div className='learn-more-container'>
          </div>
        </div>
      </div>
