          ...
          <a href='https://medium.com/@Francesco_AI/the-convergence-of-ai-and-blockchain-whats-the-deal-60c618e3accc'>
            <div className='news-detail-container'>
              <div className='news-container-padding'>
                ...
                <div className='news-caption'>It is undeniable that AI and blockchain are two of the major technologies that are catalyzing the pace of
                  innovation and introducing radical shifts in every industry. Each technology has its...</div>
          ...
          <a href='https://www.newgenapps.com/blog/future-of-ico-impact-of-initial-coin-offering'>
            <div className='news-detail-container'>
              <div className='news-container-padding'>
                ...
                <div className='news-caption'></div>
                <div className='news-caption'>ICO i.e. Initial Coin Offering is the new wave of fundraising where ideators ditch the complete hassle of
                  the lengthy funding process and raise capital via blockchain technology...</div>
                <div className='learn-more-container'>
                  <div className='news-learn-more'>Learn More</div>
                </div>
              </div>
          ...
          <a href='https://medium.com/@chain_explainer/blockchain-insider-jen-greyson-2610af01c709'>
            <div className='news-detail-container'>
              <div className='news-container-padding'>
                ...
                <div className='news-caption'></div>
                <div className='news-caption'>Recently named one of the Top 8 Women in Crypto, Jen Greyson of the Neureal Network and CEO of Powered by
                  Neureal brings decades of executive leadership to the blockchain/crypto...</div>
                <div className='learn-more-container'>
                  <div className='news-learn-more'>Learn More</div>
                </div>
              </div>
