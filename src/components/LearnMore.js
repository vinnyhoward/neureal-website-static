    ...
    return (
      <div>
            ...
            <div className="flex">
                    ...
                    <p className="content__paragraph">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.
                        </p>
            ...
            <div className="flex-reverse">
                <div className="column column__two-thirds">
                    <img src="https://image.ibb.co/g3i2d7/Comp_4.gif" alt="" className="content__image" />
                        ...
                        <div className="column column__one-third">
                            <div learn-more-flex>
                        <h3 className='sub-title'> Neureal protocal constructs the data in a hierarchical fashion 
                                allowing for accurate predictions using live data streams collected by the mining nodes.</h3>
                    <p className="content__paragraph">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.
                        </p>
                        <div className='learn-more-padding'>
                        <h3 className='sub-title'> Selling the data. Neureal marketplace will allow miners to sell the data they've gathered to the public or to private entities allowing for a better user experience.</h3>
                    <p className="content__paragraph">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.
                        </p>
                    </div>
                              </div>
